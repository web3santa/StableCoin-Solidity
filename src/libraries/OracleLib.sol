 ...
 * @title OracleLib
 * @author web3santa
 * @notice THis library is used to check the chainlink Oracle for stable sata.
 * if a price is table, the fucntion weill revert, and render the DSCEngine unuable
